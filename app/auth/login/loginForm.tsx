...
// import { fetchConsumerId } from '@utils/commonActions';
      ...
      <div className="row">
        ...
        <div className="col-lg-5 col-md-6">
          <div className="login-wrapper">
            ...
            {/* <button onClick={handleClick}>Sign in to salesforce</button> */}
            <Link className="btn btn-blue-outline w-100" href="https://login.salesforce.com/services/oauth2/authorize?response_type=code&client_id=3MVG9WVXk15qiz1JnhTsoAkAoWS9NV.xFAQZ8qEC.ZgKDLOaDtBXO4JvnoOCIyvS.KmP4jVkxjWRxkzSnUV4J&redirect_uri=http://localhost:3000/api/auth/callback/salesforce&scope=full">
